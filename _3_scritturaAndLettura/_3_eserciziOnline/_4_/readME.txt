...
più frequenti (o anche le lettere più frequenti). Vogliamo realizzare la classe FileAndParole, che effettua alcune di queste
operazioni ed è composta dai
seguenti metodi:
...
le chiavi sono le parole e i valori sono il numero di occorrenze delle parole stesse nel testo.
 In questo caso il testo può comprendere punteggiatura e lettere maiuscole. SUGGERIMENTO:
 per eliminare la punteggiatura da una riga di testo utilizzare il metodo
riga.split("\W+").
